...
export function MobileBottomNav() {
  ...
  return (
    <>
        ...
        {bottomItems.map((item, idx) => {
          ...
          if (item.isDrawerTrigger) {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center gap-1 py-1 px-3 text-[11px] font-medium transition-colors cursor-pointer active:scale-95 ${
                  isActive
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center gap-1 py-1 px-3 text-[11px] font-medium transition-colors active:scale-95 ${
                isActive
                  ? "font-semibold text-brand-blue dark:text-brand-green"
                  : "text-muted-foreground hover:text-foreground"
              }`}
      ...
      {isDrawerOpen && (
        <div
          className="fixed inset-0 z-60 bg-black/60 backdrop-blur-xs transition-opacity duration-300 lg:hidden animate-in fade-in"
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
          ...
          {isAuthenticated && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 p-3 text-xs font-bold text-destructive rounded-2xl border border-destructive/20 bg-destructive/5 hover:bg-destructive/10 transition-colors cursor-pointer"
            >
