        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-stretch">
              ...
              {SPORTS.map((sport) => {
                ...
                return (
                  <button
                    ...
                    className={`relative px-3.5 py-1.5 text-xs sm:text-sm font-medium whitespace-nowrap rounded-xl transition-all duration-200 cursor-pointer ${isActive
          ...
          <div className="lg:col-span-3 xl:col-span-4 relative rounded-2xl overflow-hidden bg-slate-900 text-white flex flex-col justify-between shadow-md border border-slate-800 min-h-[360px] lg:min-h-[400px]">
            ...
            <div className="relative z-10 bg-slate-950/90 backdrop-blur-sm p-4 sm:p-5 border-t border-slate-800/80 space-y-4">
              ...
              <Link
                href="/leaderboard"
                className="w-full h-9 sm:h-10 px-4 rounded-xl bg-gradient-primary hover:opacity-95 text-white font-bold text-xs sm:text-sm shadow-2xs transition-all text-center flex items-center justify-center active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-3 xl:col-span-3 relative rounded-2xl bg-card border border-border/80 p-5 sm:p-6 flex flex-col justify-between overflow-hidden shadow-2xs min-h-[320px] lg:min-h-[400px]">
            ...
            <div className="relative z-10 space-y-2.5">
              ...
              <div className="pt-1">
                <Link
                  href="/tournaments"
                  className="inline-flex items-center justify-center h-9 sm:h-10 px-4 rounded-xl bg-gradient-primary text-white font-bold text-xs sm:text-sm shadow-2xs transition-all w-full text-center active:scale-[0.98]"
                >
