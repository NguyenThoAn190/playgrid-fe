...
export function ContactEmergencyBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-brand-blue/90 via-brand-blue to-emerald-600 dark:from-[#0a192f] dark:via-[#0f283d] dark:to-[#0d3b2b] p-6 sm:p-10 text-white shadow-sm border border-white/10">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 text-[11px] sm:text-xs font-semibold backdrop-blur-xs">
